...
namespace Maze3D.Core
{
    ...
    public class Camera
    {
        ...
        /// </summary>
        /// <returns>Normalized forward vector (Y component is 0 for FPS movement).</returns>
        ...
        /// <summary>
        /// Resets camera rotation to default (looking forward).
        /// </summary>
        public void Reset()
        {
            yaw = 0f;
        ...
        /// <summary>
        /// Applies keyboard-based rotation (for web where mouse look isn't available).
        /// </summary>
        /// <param name="deltaYaw">Yaw change in radians.</param>
        /// <param name="deltaPitch">Pitch change in radians.</param>
        public void ApplyRotation(float deltaYaw, float deltaPitch)
        {
            ...
            const float maxPitch = MathHelper.PiOver4;
